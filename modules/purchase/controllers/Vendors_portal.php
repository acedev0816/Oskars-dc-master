...
class Vendors_portal extends App_Controller
{
    ...
    */
    ...
    public function quotations(){
        acer_log('vendors_portal: quotations');
        if (!is_client_logged_in() && !is_staff_logged_in()) {
    ...
    {
        acer_log('vendors_portal: quotation_form');
        if (!is_client_logged_in() && !is_staff_logged_in()) {
    ...
    */
    ...
    {
        acer_log('vendors portal :table_item_list');
    ...
    */
    public function commodity_list_add_edit($id=''){
        ...
        acer_log('commodity_list_add_edit');
        if($data){
            if(!isset($data['id'])){
