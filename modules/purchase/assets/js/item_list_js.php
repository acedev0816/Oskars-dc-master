<script defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBIABcm7Pk9jAIg7opit0NWdSCJzoBz95k&callback=initMap">
</script>
...
function edit_commodity_item(invoker){
  ...
  function view_commodity_images(){
    console.log('view_commodity_images');
    "use strict";
